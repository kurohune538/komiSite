...
function showWebWorks() {
  ...
  $('.web-works .centering-wrapper img').animate({
    width: '5%',
  }, 0);
}
function resetWorks () {
  ...
  $('.web-works .centering-wrapper, .app-works .centering-wrapper, .hardware-works .centering-wrapper, .mp-works .centering-wrapper').css('display', 'none');
